...
<section class="mt-20 px-8 md:px-10 flex justify-center">
  <div class="flex flex-col max-w-2xl w-full">
    ...
    {#if markdownComponent}
      ...
      <article class="prose prose-ul:list-[square] marker:text-[#424242] prose-sm max-w-none prose-p:my-4 prose-headings:my-4 prose-ul:my-0 prose-li:my-0 prose-headings:text-[#424242] prose-a:text-[#424242] text-[#565656] text-[clamp(1.25rem,4vw,1.5rem)] mt-4">
        <Markdown />
      </article>
    {/if}
  </div>

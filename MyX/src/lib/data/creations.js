export const creations = [
  ...
  },
  {
    ...
    description: "A public API for students to access realistic synthetic data from University of Washington, enabling prototypes with safe and high-fidelity data",
    status: "In Progress",
